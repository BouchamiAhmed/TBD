...
type ComplexityRoot struct {
	...
	Mutation struct {
		...
		Register func(childComplexity int, username string, password string, email string, firstName string, lastName string, userType string) int
	}
...
type MutationResolver interface {
	...
	Register(ctx context.Context, username string, password string, email string, firstName string, lastName string, userType string) (*model.AuthPayload, error)
}
...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.register":
		...
		return e.complexity.Mutation.Register(childComplexity, args["username"].(string), args["password"].(string), args["email"].(string), args["firstName"].(string), args["lastName"].(string), args["userType"].(string)), true
...
var sources = []*ast.Source{
	{Name: "../schema.graphql", Input: `# GraphQL Schema for LDAP Authentication
...
func (ec *executionContext) field_Mutation_register_args(ctx context.Context, rawArgs map[string]any) (map[string]any, error) {
	...
	args["email"] = arg2
	arg3, err := graphql.ProcessArgField(ctx, rawArgs, "firstName", ec.unmarshalNString2string)
	if err != nil {
		return nil, err
	}
	args["firstName"] = arg3
	arg4, err := graphql.ProcessArgField(ctx, rawArgs, "lastName", ec.unmarshalNString2string)
	if err != nil {
		return nil, err
	}
	args["lastName"] = arg4
	arg5, err := graphql.ProcessArgField(ctx, rawArgs, "userType", ec.unmarshalNString2string)
	if err != nil {
		return nil, err
	}
	args["userType"] = arg5
...
func (ec *executionContext) _AuthPayload_user(ctx context.Context, field graphql.CollectedField, obj *model.AuthPayload) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNUser2ᚖldaptestᚋgraphᚋmodelᚐUser,
		true,
		true,
	)
}
...
func (ec *executionContext) _Mutation_login(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNAuthPayload2ᚖldaptestᚋgraphᚋmodelᚐAuthPayload,
		true,
		true,
	)
}
...
func (ec *executionContext) _Mutation_register(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.resolvers.Mutation().Register(ctx, fc.Args["username"].(string), fc.Args["password"].(string), fc.Args["email"].(string), fc.Args["firstName"].(string), fc.Args["lastName"].(string), fc.Args["userType"].(string))
		},
		nil,
		ec.marshalNAuthPayload2ᚖldaptestᚋgraphᚋmodelᚐAuthPayload,
		true,
...
func (ec *executionContext) _Query_me(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalOUser2ᚖldaptestᚋgraphᚋmodelᚐUser,
		true,
		false,
	)
}
...
func (ec *executionContext) marshalNAuthPayload2ldaptestᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v model.AuthPayload) graphql.Marshaler {
	return ec._AuthPayload(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthPayload2ᚖldaptestᚋgraphᚋmodelᚐAuthPayload(ctx context.Context, sel ast.SelectionSet, v *model.AuthPayload) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNUser2ᚖldaptestᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOUser2ᚖldaptestᚋgraphᚋmodelᚐUser(ctx context.Context, sel ast.SelectionSet, v *model.User) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._User(ctx, sel, v)
